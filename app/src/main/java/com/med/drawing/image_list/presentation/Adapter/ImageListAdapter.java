...
public abstract class ImageListAdapter extends RecyclerView.Adapter<ImageListAdapter.DrawingListHolder> {
        ...
        try {
            ...
            drawingListHolder.card_layout.setOnClickListener(new View.OnClickListener() { 
                ...
                public void onClick(View view) {
                    ImageListAdapter.this.onDrawingListClickItem(i, view);
                }
            });
            drawingListHolder.card_layout2.setOnClickListener(new View.OnClickListener() {
                @Override 
                public void onClick(View view) {
                    ImageListAdapter.this.onGalleryClickItem(i, view);
                }
            });
        } catch (Exception e) {
            e.toString();

...
public class SketchActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        String imagePath = Objects.requireNonNull(getIntent().getExtras()).getString("imagePath");
        ...
        this.brightness_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i2, boolean z) {
                if (i2 <= 20) {
                    SketchActivity.this.brightness = 20;
                } else {
                    SketchActivity.this.brightness = i2;
                }
                WindowManager.LayoutParams attributes2 = SketchActivity.this.window.getAttributes();
                attributes2.screenBrightness = SketchActivity.this.brightness / 255.0f;
                SketchActivity.this.window.setAttributes(attributes2);
            }
        });
        if (imagePath != null) {
            if (imagePath.contains("sketch_drawing")) {
                this.bmOriginal = AppConstant.getBitmapFromAsset(this, imagePath);
            } else {
                this.bmOriginal = AppConstant.getBitmap(imagePath);
            }
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            @Override 
            public void run() {
                SketchActivity.this.animation_view.setVisibility(View.GONE);
            }
        }, 7000L);
        this.CameraPic.setOnClickListener(new View.OnClickListener() {
            @Override 
            public void onClick(View view) {
                view.startAnimation(SketchActivity.this.pushanim);
                ImagePicker.with(SketchActivity.this).cameraOnly().saveDir(SketchActivity.this.getExternalFilesDir(Environment.DIRECTORY_DCIM)).start(103);
        ...
        this.GalleryPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.startAnimation(SketchActivity.this.pushanim);
                ImagePicker.with(SketchActivity.this).galleryOnly().start(102);
        ...
        this.rel_flip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sketchActivity.bmOriginal = SketchActivity.flip(sketchActivity.bmOriginal, 2);
                if (SketchActivity.this.bmOriginal != null) {
                    SketchActivity.this.objectImage.setImageBitmap(SketchActivity.this.bmOriginal);
                }
            }
        });
        this.ImageEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.startAnimation(SketchActivity.this.pushanim);
                SketchActivity.this.ColorDialog();
            }
        });
        this.ImageLock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.startAnimation(SketchActivity.this.pushanim);
                if (!SketchActivity.this.is_lock) {
                    SketchActivity.this.objectImage.setEnabled(false);
                    SketchActivity.this.is_lock = true;
                    SketchActivity.this.img_lock.setImageResource(R.drawable.unlock);
                    return;
                }
                SketchActivity.this.objectImage.setEnabled(true);
                SketchActivity.this.is_lock = false;
                SketchActivity.this.img_lock.setImageResource(R.drawable.lock);
            }
        });
        this.opacity_seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override 
            public void onProgressChanged(SeekBar seekBar, int i2, boolean z) {
                SketchActivity.this.objectImage.setAlpha((SketchActivity.this.opacity_seekbar.getMax() - i2) / 10.0f);
            }
        });
    }
    ...
    public void ColorDialog() {
        new SpectrumDialog.Builder(this).setColors(R.array.demo_colors).setSelectedColorRes(R.color.black).setDismissOnColorSelected(true).setOutlineWidth(2).setFixedColumnCount(4).setOnColorSelectedListener(new SpectrumDialog.OnColorSelectedListener() {
            ...
            public void onColorSelected(boolean z, int i) {
                if (z) {
                    SketchActivity.this.main_layout.setBackgroundColor(i);
                }
            }
